...
Read `docs/CODING_GUIDELINES.md` and `docs/TESTING_GUIDELINES.md` before changing code — both have concrete good/bad examples pulled from this codebase and are treated as binding conventions, not suggestions.
